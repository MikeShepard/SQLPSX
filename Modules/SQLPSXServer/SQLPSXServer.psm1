...
.DESCRIPTION
The Get-SqlPSXDatabase function  gets an SMO Database object for the specified SQL Database or collection of Database objects.
.INPUTS
None
...
.DESCRIPTION
The Get-SqlPSXErrorLog function returns the SQL Server Errorlog.
.INPUTS
None
    You cannot pipe objects to Get-SqlErrorLog
.OUTPUTS
System.Data.DataRow
    Get-SqlPSXErrorLog returns an array of System.Data.DataRow.
.EXAMPLE
Get-SqlPSXErrorLog "Z002\sql2k8"
This command returns the current SQL ErrorLog on the Z002\sql2k8 server.
.LINK
Get-SqlPSXErrorLog
#>
function Get-SqlPSXErrorLog
{
    param(
    [Parameter(Mandatory=$true)] $sqlserver,
    [int]$lognumber=0
